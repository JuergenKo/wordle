...
if sys.platform == 'android':
    ...
    Config.set('graphics', 'resizeable', '0')  # Usually not resizeable on mobile
    Config.set('graphics', 'window_state', 'maximized')
    Config.set('graphics', 'borderless', '1')
    Config.set('graphics', 'show_cursor', '0')  # Hide cursor on touch devices
else:
    # Desktop development settings
    Config.set('graphics', 'width', '400')
    Config.set('graphics', 'height', '700')
    Config.set('graphics', 'resizeable', '1')  # Allow resizing on desktop
    Config.set('graphics', 'borderless', '0')
    Config.set('graphics', 'show_cursor', '1')  # Show cursor on desktop
