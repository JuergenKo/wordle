...
if sys.platform == 'win32':
    ...
    # Platform-specific import for KivMob
ads = None
banner_ad_id = None
if platform == 'android':
    try:
        from kivmob import KivMob
        ads = KivMob('ca-app-pub-3940256099942544~3347511713')  # TEST APP ID
        banner_ad_id = 'ca-app-pub-3940256099942544/6300978111' # TEST UNIT ID
    except Exception as e:
        print(f"Could not import KivMob: {e}")
        ads = None
else:
    print("Not on Android, ads disabled.")
...
class WordleHelperApp(MDApp):
    ...
    def on_start(self):
        ...
        if platform == 'android' and ads:
            try:
                ads.new_banner(banner_ad_id)
                ads.banner_pos = 'bottom'
                ads.show_banner()
