...
class WordleHelperApp(App):
    ...
    def on_start(self):
        ...
        try:
            ...
            # Additional Android fix: schedule another resize after a delay
            if sys.platform == 'android':
    ...
    def process_and_get_suggestions(self, instance):
        ...
        # Use a timestamp to detect rapid double clicks
        ...
        #print(f"DEBUG: process_and_get_suggestions called with instance: {instance}")
        ...
        try:
            ...
            print(f"Error in process_and_get_suggestions: {e}")
            self.status_label.text = f"Error: {str(e)}"
            
        finally:
            # Always reset the processing flag, even if there's an error
            self._processing = False
            #print("DEBUG: Processing flag reset")
...
if __name__ == '__main__':
    # Additional Android initialization
    if sys.platform == 'android':
        try:
